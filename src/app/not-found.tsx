  ...
  return (
    ...
    >
      ...
      >
        {mountainLayers.map((layer, i) => (
          <motion.path
            ...
            transition={{ delay: i * 0.12, duration: 1.4, ease: [0.16, 1, 0.3, 1] }}
          />
        ))}
      </svg>
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-6 px-6">
        <motion.p
          className="font-display text-[10rem] sm:text-[14rem] font-semibold leading-none text-white/15 select-none"
        ...
        <motion.div
          className="flex flex-col gap-3 -mt-8 sm:-mt-12"
        ...
        >
          ...
          <p className="text-white/65 text-base max-w-sm leading-relaxed">
            This page doesn't exist or has been moved somewhere further up the trail.
          </p>
        </motion.div>
